...
kdr::Graphics::VBO::VBO(const GLfloat vertices[], GLsizeiptr size)
{
...
kdr::Graphics::EBO::EBO(const GLuint indices[], GLsizeiptr size)
{
  glGenBuffers(1, &this->ID);
  this->Bind();
...
void kdr::Graphics::VAO::LinkAttrib(kdr::Graphics::VBO& VBO, GLuint layout, GLuint size, GLenum type, GLsizeiptr stride, const void* offset)
{
  VBO.Bind();
